...
<body>
	...
	<form action="<%=contPath %>/board/board.do" name="boardFrm" id="boardFrm">
	   ...
	   <table widht="600">
	       ...
	       <tr>
               <td width="100">등록자</td>
               <td width="500"><input value="${vo.regId}" type="text" name="reg_id" id="reg_id" maxlength="200" size="50" readonly="readonly"></td>
           </tr>
           <tr>
               <td width="100">등록일</td>
               <td width="500"><input value="${vo.regDt}" type="text" name="regDt" id="regDt" maxlength="200" size="50" readonly="readonly"></td>
           </tr>
           <tr>
               <td width="100">수정자</td>
               <td width="500"><input value="${vo.modId}" type="text" name="mod_id" id="mod_id" maxlength="200" size="50"></td>
           </tr>
	       <tr>
               <td width="100">수정일</td>
               <td width="500"><input value="${vo.modDt}" type="text" name="modDt" id="modDt" maxlength="200" size="50" readonly="readonly"></td>
           </tr>
           <tr>
               <td width="100">조회수</td>
               <td width="500"><input value="${vo.readCnt}" type="text" name="readCnt" id="readCnt" maxlength="200" size="50" readonly="readonly"></td>
           </tr>       
    	    <tr>
               <td colspan="2">내용</td>
           </tr>
            <tr>
               <td colspan="2"><textarea rows="5" cols="50" name="contents" id="contents">${vo.contents}</textarea></td>
           </tr>    
	   </table>
	</form>
